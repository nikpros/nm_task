<template>
    ...
    >
        ...
        <v-card-text>
            <v-row>
                ...
                <v-col class="text-right">
                    <v-chip color="deep-purple accent-4 white--text">{{ meeting.time_str }}</v-chip>
                </v-col>
            </v-row>
            <v-row>
                <v-col class="d-flex align-center">
                ...
                <v-col class="text-right">
                    <v-chip color="deep-purple accent-4 white--text">{{ meeting.time_fsh }}</v-chip>
                </v-col>
            </v-row>
            <v-row>
                <v-col class="d-flex align-center">
                ...
                <v-col class="text-right">
                    <v-chip class="white--text" :color="status === 'plainning' ? 'yellow accent-4' : status === 'online' ? 'success' : 'error'">{{ status }}</v-chip>
                </v-col>
            </v-row>
        </v-card-text>
        <v-card-actions>
        ...
        <v-expand-transition>
            ...
            <v-divider></v-divider>
                <v-list-item
                v-for="(name, i) in meeting.participants"
                :key="i">
                    <v-list-item-avatar>
